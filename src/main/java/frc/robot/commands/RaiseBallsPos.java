...
public class RaiseBallsPos extends CommandBase {
  ...
  public RaiseBallsPos(BallSubsystem balls, NetworkTableEntry position, NetworkTableEntry k_P) {
      this.balls = balls;
  ...
  public void initialize() {
    ...
    balls.liftToPos(position.getDouble(balls.getStartPosition()), k_P.getDouble(0.3));
  }
